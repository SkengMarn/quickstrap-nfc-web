-- Multi-Series Events Migration
-- Creates tables for event series functionality with backwards compatibility
...
-- 3. Add has_series flag to events table (for performance optimization)
...
-- 5. Add series_id to checkin_logs for tracking (optional)
...
RETURNS TRIGGER AS $$
BEGIN
  -- Update the parent event's has_series flag
...
-- Migration complete!
-- Run this script to add multi-series events support to your QuickStrap system
