...
import { Organization, OrganizationMember } from '../types/phase1';
...
export const OrganizationProvider: React.FC<OrganizationProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    // TEMPORARY: Disable auto-load to prevent RLS hang
    console.log('OrganizationContext: Auto-load DISABLED - preventing RLS hang');
    setLoading(false);
